...
<head>
    ...
    <head>
        ...
        .navigation li.menu-item-has-children .sub-menu {
            ...
            transition: opacity 0.2s ease-in-out, transform 0.4s ease-in-out, visibility 0.4s;
        }
...
<body class="body-gray-bg">
    ...
    <div class="extra-info">
        ...
        <div class="logo-side">
            <a href="index.php"><img src="assets/img/footer/expressloom10.png" alt="#" style=" width:100px;"></a>
        </div>
        <div class="side-info">
                    ...
                    <div class="main-header-one__inner">
                        ...
                        <div class="main-header-one__inner-left">
                            <div class="logo-box-one">
                                <a href="index.php">
                                    <img src="assets/img/resource/expresslomlogo-removebg-preview.png" alt="Logo"
                                            ...
                                            <div class="navbar-wrap main-menu">
                                                <ul class="navigation">
                                                    ...
                                                    <li class="menu-item-has-children"><a>About Us</a>
                                                        <ul class="sub-menu">
                                                            <li><a href="aboutcompany.php">About Company</a></li>
                            ...
                            <div class="about-two__contant-box">
                                ...
                                <div class="text">
                                    <p>It is a long established fact that a reader will be distracted by the readablejk
                                        content of a page when looking at its layout. Lorem Ipsum is simply dummyjl text
                                        of
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonials-two__single">
                                        ...
                                        <div class="testimonials-two__single-content">
                                            <div class="text">
                                                <p>
                                                    It is a long established fact that a reader willklil beinl
                                                    distracted by
                                                    the
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="single-footer-widget single-footer-widget--two">
                                        ...
                                        <div class="footer-widget__links-box">
                                            <ul>
                                                <li>
                                                    <a href="#"><span class="icon-chevron"></span>Software
                                                        Development</a>
                                                </li>
                                                <li>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="single-footer-widget single-footer-widget--two ml-52">
                                        ...
                                        <div class="single-footer-widget__contact-info">
                                            <div class="text">
                                                <p>Lorem Ipsum is simply is dumi omy is text dummy text.</p>
                                            </div>
                                            <ul class="clearfix">
                                                <li>
                                                    <div class="icon">
                    ...
                    <div class="container">
                        <div class="footer-middle__inner">
                            <div class="footer-logo-box">
                                <img src="assets/img/footer/footer-three-logo_img-2.png" alt="#">
                            </div>
                    ...
                    <div class="container">
                        <div class="footer-bottom__inner">
                            <div class="copyright-text copyright-text--two">
                                <p>© Yoursitename 2023 | <a href="index.html">Nocimon</a>, All Rights Reserved.</p>
                            </div>
...
<!-- Mirrored from itcroctheme.com/nocimon/nocimon-html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jan 2025 13:34:33 GMT -->
