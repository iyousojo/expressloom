...
<head>
    ...
    <title>contact us|| Expessloom</title>
...
<body class="body-gray-bg">
    ...
    <div class="extra-info">
        ...
        <div class="logo-side">
            <a href="index.php"><img src="assets/img/footer/expressloom10.png" alt="#" style="width: 50px;"></a>
        </div>
        <div class="side-info">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <h4>Send us email</h4>
                                        <p>
                                            <a href="mailto:demo0023yourmailhotmail.com">demo0023yourmailhotmail.com</a>
                                        </p>
                                        <p>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="contact-one__form">
                            <form id="contact-form"
                                action="https://itcroctheme.com/Expessloom/Expessloom-html/assets/inc/mail.php"
                                method="POST">
                                <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="single-footer-widget single-footer-widget--two">
                                    ...
                                    <div class="footer-widget__links-box">
                                        <ul>
                                            <li>
                                                <a href="#"><span class="icon-chevron"></span>Free Industry Insights or
                                            ...
                                            <li>
                                                <a href="#"><span class="icon-chevron"></span> Free eBook:
                                                    <br>Streamline Your Supply Chain </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="#"><span class="icon-chevron"></span> Free Logistics Audit</a>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <ul class="clearfix">
                                            ...
                                            <li>
                                                ...
                                                <div class="title-box">
                                                    ...
                                                    <h5><a href="#">The Role of AI and Automation in Supply Chain
                                                            Optimization</a></h5>
                                                </div>
                                            </li>
                                        </ul>
