...
$qry = $conn->query("SELECT p.*, pt.name AS payment_method FROM parcels p LEFT JOIN payment_types pt ON p.payment_method = pt.id WHERE p.id = " . $_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
            ...
            <div class="col-md-6">
                <div class="callout callout-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <dl>
                                ...
                                <dt>Type:</dt>
                                <dd><?php echo $type == 1 ? "<span class='badge badge-primary'>Deliver to Recipient</span>":"<span class='badge badge-info'>Pickup</span>" ?>
                                </dd>
                            </dl>
                        </div>
                    </div>
                    <dl>
                        ...
                        <dd><?php echo htmlspecialchars($payment_method, ENT_QUOTES, 'UTF-8'); ?></dd>
                        <dt>Status:</dt>
                        <dd>
                            <?php 
							switch ($status) {
                            ...
                            <span class="btn badge badge-primary bg-gradient-primary" id='update_status'><i
                                    class="fa fa-edit"></i> Update Status</span>
                        </dd>
