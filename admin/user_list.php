        ...
        <div class="card-body">
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    <?php
					$i = 1;
					$qry = $user_db->query("SELECT *, concat(last_name, ', ', first_name, ' ', middle_name) as name FROM users ORDER BY concat(last_name, ', ', first_name, ' ', middle_name) ASC");
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $row['account_type'] ?></b></td>
